...
namespace NotatApp.Migrations
{
    ...
    [Migration("20260623141802_RecommendedSong-country,style")]
    partial class RecommendedSongcountrystyle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotatApp.Models.RecommendedSong", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NotatApp.Models.RecommendedSong", b =>
                {
                    b.HasOne("NotatApp.Models.DiaryEntry", "DiaryEntry")
                        .WithOne()
                        .HasForeignKey("NotatApp.Models.RecommendedSong", "DiaryEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
